...
type
  TDMCadEmpresa = class(TDataModule)
    ...
    sdsEmpresa_DiretoriaENDERECO: TStringField;
    sdsEmpresa_DiretoriaCOMPLEMENTO_END: TStringField;
    sdsEmpresa_DiretoriaNUM_END: TStringField;
    sdsEmpresa_DiretoriaBAIRRO: TStringField;
    sdsEmpresa_DiretoriaCEP: TStringField;
    sdsEmpresa_DiretoriaID_CIDADE: TIntegerField;
    sdsEmpresa_DiretoriaCIDADE: TStringField;
    sdsEmpresa_DiretoriaUF: TStringField;
    sdsEmpresa_DiretoriaEMAIL: TStringField;
    cdsEmpresa_DiretoriaENDERECO: TStringField;
    cdsEmpresa_DiretoriaCOMPLEMENTO_END: TStringField;
    cdsEmpresa_DiretoriaNUM_END: TStringField;
    cdsEmpresa_DiretoriaBAIRRO: TStringField;
    cdsEmpresa_DiretoriaCEP: TStringField;
    cdsEmpresa_DiretoriaID_CIDADE: TIntegerField;
    cdsEmpresa_DiretoriaCIDADE: TStringField;
    cdsEmpresa_DiretoriaUF: TStringField;
    cdsEmpresa_DiretoriaEMAIL: TStringField;
